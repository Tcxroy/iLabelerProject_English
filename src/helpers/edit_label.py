...
def add_an_icon(driver, row, col):
    edit_page = EditLabelPage(driver) 
    edit_locator = EditLabelLocators()
...
def add_a_date_from_calender(driver, day, month, year, row = 1, col = 1):
    edit_page = EditLabelPage(driver)
    edit_locator = EditLabelLocators()
